...
The sets of data for this project can be retrieve using the following link:
https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip

The script run_analysis.R included in the repository when executed will download
the above data set from the .zip file and combine files of test and train measurements,
along with the 6 activities and the names of the each of the columns in the test and
train files and combine them into a single file. Then a second file will be produced where
only mean and standard deviation data is extracted and the mean of those columns is 
calculated based on each subject and the activity.